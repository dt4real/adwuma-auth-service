...
* Steps to build and push your image to docker hub
  * `docker build -t <your-dockerhub-username>/adwuma-auth .`
  * `docker tag <your-dockerhub-username>/adwuma-auth <your-dockerhub-username>/adwuma-auth:stable`
  * `docker push <your-dockerhub-username>/adwuma-auth:stable`